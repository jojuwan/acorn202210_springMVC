...
public class Boot02Hello2Application {
	//Spring Boot Application 이 시작되는 main 메소드
	public static void main(String[] args) {
		ApplicationContext ctx=SpringApplication.run(Boot02Hello2Application.class, args);
		// getBean( 원하는 type )
		...
		ApplicationContext ctx2=new ClassPathXmlApplicationContext("congif.xml");
